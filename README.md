...
All you need is import the `react-native-markdown-text` and then use the `<Markdown />` component.
...
This project was forked from [`react-native-simple-markdown`](https://github.com/CharlesMangwa/react-native-simple-markdown) by [@CharlesMangwa](https://github.com/CharlesMangwa).
